...
const RACES = {
    ...
    UD: { name: '亡灵', color: '#4a148c', icon: '<svg width="16" height="16" viewBox="0 0 16 16"><path d="M8 0C4.5 0 2 2.5 2 6v6c0 1 .8 1.8 1.8 1.8 .2 0 .4-.2.5-.4 .2-.4-.1-.8-.4-.8H5.3c-.2 0-.4-.2-.4-.5v-.4c0-.2.2-.4.4-.4h5.4c.2 0 .4.2.4.4v.4c0 .3-.2.5-.4.5H10c-.3 0-.6.4-.4.8 .1.2.3.4.5.4C11.2 13.8 12 13 12 12V6c0-3.5-2.5-6-6-6zm-2.5 6c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm5 0c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z" fill="#9b59b6"/></svg>' },
