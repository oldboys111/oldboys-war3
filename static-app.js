...
const RACES = {
    ...
    UD: { name: '亡灵', color: '#4a148c', icon: '<img src="images/不死.jpg" alt="亡灵" style="width:80px;height:80px;object-fit:contain;border-radius:8px;">' },
                        ...
                        ${levelPlayers.map(p => {
                            ...
                            return `
                                <tr onclick="showPlayerDetail('${p.id}')">
                                    ...
                                    <td>
                                        <div class="name-cell">
                                            <div class="member-avatar-small">${p.race === 'NE' ? '<img src="images/暗夜.jpg" style="width:36px;height:36px;object-fit:contain;border-radius:4px;">' : p.race === 'UD' ? '<img src="images/不死.jpg" style="width:36px;height:36px;object-fit:contain;border-radius:4px;">' : (p.race && RACES[p.race] ? RACES[p.race].icon : '')}</div>
                                            <span>${p.name}</span>
                                        </div>
                                    </td>
...
function renderPlayerDetail(playerId) {
    ...
    document.getElementById('detail-avatar').innerHTML = player.race === 'NE'
        ? '<img src="images/暗夜.jpg" alt="暗夜" style="width:80px;height:80px;object-fit:contain;border-radius:8px;">'
        : player.race === 'UD'
        ? '<img src="images/不死.jpg" alt="亡灵" style="width:80px;height:80px;object-fit:contain;border-radius:8px;">'
            ...
            return `
                <div class="battle-item">
                    <div class="battle-opponent">
                        ...
                        ? '<img src="images/暗夜.jpg" style="width:32px;height:32px;vertical-align:middle;border-radius:4px;">'
                        : opponent.race === 'UD'
                        ? '<img src="images/不死.jpg" style="width:32px;height:32px;vertical-align:middle;border-radius:4px;">'
...
function renderMatches(filterType = 'all', playerSearch = '') {
    ...
    const html = matches.map(m => {
        ...
        const redNames = redIds.map(id => {
            ...
            const level = getPlayerLevel(p.id);
            const raceImg = p.race === 'NE' ? '<img src="images/暗夜.jpg" style="width:32px;height:32px;vertical-align:middle;border-radius:3px;">' : p.race === 'UD' ? '<img src="images/不死.jpg" style="width:32px;height:32px;vertical-align:middle;border-radius:3px;">' : (p.race && RACES[p.race] ? RACES[p.race].icon : '');
