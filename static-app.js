...
const RACES = {
    ...
    UD: { name: '亡灵', color: '#4a148c', icon: '<svg width="16" height="16" viewBox="0 0 16 16"><path d="M8 1C5 1 3 3 3 6v7c0 1 1 2 2 2h2c1 0 1-1 1-1s0-1 1-1h2c1 0 1 1 1 1s0 1 1 1h1c1 0 2-1 2-2V6c0-3-2-5-5-5zm-3 6a1 1 0 110 2 1 1 0 010-2zm6 0a1 1 0 110 2 1 1 0 010-2z" fill="#9b59b6"/></svg>' },
